...
describe('Accept Friend Invite (e2e)', () => {
  ...
  test('[PUT] /invite-friendship-accept', async () => {
    ...
    expect(friendshipOnDatabase?.status).toEqual('ACCEPTED')
  })

  test('[PUT] /invite-friendship-accept without a token fails', async () => {
  ...
  test('[PUT] /invite-friendship-accept by the sender fails', async () => {
  ...
  test('[PUT] /invite-friendship-accept by an unrelated user fails', async () => {
    const { friendshipId } = await createPendingFriendship()
  ...
  test('[PUT] /invite-friendship-accept on an unknown friendship fails', async () => {
  ...
  test('[PUT] /invite-friendship-accept on an already accepted friendship fails', async () => {
    const { recipient, friendshipId } = await createPendingFriendship()
