...
| 05 | [05-websocket.md](./05-websocket.md) | Handshake (cookie + `deviceId`), códigos de fechamento, de onde vem o cursor de reconexão, e onde o backpressure vira palpável no pipeline até o socket |
